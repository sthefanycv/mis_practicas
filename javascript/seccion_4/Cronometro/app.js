...
let contadorMin = 0;
let vuelta = 0;
let incremento; // En esta variable se guarda el intervalo de tiempo que actualiza el cronometro.
...
capturar.addEventListener("click",function(){
    ...
    if(lista.classList.contains("lista_oculto")){lista.classList.add("lista"); lista.classList.remove("lista_oculto"); lista.innerText ="N° Tiempo ⏱"};
    // Capturar Tiempos
